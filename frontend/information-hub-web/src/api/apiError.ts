...
const ERROR_MESSAGES: Readonly<Record<string, string>> = {
  ...
  RECOMMENDATION_PROMPT_PROFILE_NOT_FOUND: '绑定的 Prompt Profile 不存在',
  RECOMMENDATION_PROMPT_PROFILE_INCOMPATIBLE: '请选择用于职位相关性分析的 Prompt Profile',
  RECOMMENDATION_PROMPT_PROFILE_DISABLED: '绑定的 Prompt Profile 已停用',
  RECOMMENDATION_PROMPT_PROFILE_VERSION_REQUIRED: '绑定的 Prompt Profile 尚无 Active Version',
  RECOMMENDATION_PROMPT_ACTIVE_VERSION_REQUIRED: '绑定的 Prompt Profile 必须启用并具有 Active Version',
